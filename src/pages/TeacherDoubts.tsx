...
import { MessageCircle, User, Clock, CheckCircle, Send } from 'lucide-react';
import { dummyDoubts, Doubt } from '@/data/dummyDoubts';
              ...
              filteredDoubts.map((doubt) => (
                <Card 
                  ...
                  className={`cursor-pointer transition-colors hover:border-primary ${
                    selectedDoubt?.id === doubt.id ? 'border-primary' : ''
                  }`}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{selectedDoubt.studentName}</p>
                  </div>

                  <div>
                    <p className="text-sm font-medium mb-1">Course:</p>
                    <p className="text-sm text-muted-foreground">
                      {selectedDoubt.courseName} - Lecture {selectedDoubt.lectureNumber}
                    </p>
                  </div>

                  <div>
                    <p className="text-sm font-medium mb-1">Topic:</p>
                    <p className="text-sm text-muted-foreground">{selectedDoubt.subject}</p>
                  </div>
